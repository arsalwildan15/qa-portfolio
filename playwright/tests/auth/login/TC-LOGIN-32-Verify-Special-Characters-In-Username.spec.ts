/**
 * ========================================================================
 * TC-LOGIN-32 — Special characters in username do not crash the server
 * Module  : Authentication — Login
 * Type    : [!] Edge
 * Target  : https://opensource-demo.orangehrmlive.com/web/index.php/auth/login
 * File    : TC-LOGIN-32-Verify-Special-Characters-In-Username.spec.ts
 * Path    : tests/auth/login/
 * ========================================================================
 *
 * DESCRIPTION:
 *   Verifies that special characters in username do not crash the server.
 *
 * API VERIFIED:
 ...
 *
 * RUN THIS TEST:
 *   npx playwright test tests/auth/login/TC-LOGIN-32-Verify-Special-Characters-In-Username.spec.ts --project=login-tests --headed
 *
 * RUN ALL LOGIN TESTS:
...
// GROUP 5 — EDGE: symbol characters in the username must not break request encoding.
test.describe('Login — Authentication', () => {
  ...
  // [!] Edge: special/symbol characters in the username must not crash the server.
  test('TC-LOGIN-32 — Special characters in username do not crash the server', async ({ page }) => {
    ...
    const response = await loginPage.submitAndInterceptExpectingRejection('Admin@#$%^&*()', VALID_PASSWORD);
    ...
    printTcSummary('TC-LOGIN-32', 'Special characters in username do not crash the server', checks);
